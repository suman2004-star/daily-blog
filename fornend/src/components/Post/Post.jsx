...
function Post() {
  ...
  const getPost = async () => {
    try {
      const response = await axios.get(`https://daily-blog-backend.vercel.app/api/v1/posts/posts/${id}`);
  ...
  const deletePost = async () => {
    ...
    try {
      await axios.delete(`https://daily-blog-backend.vercel.app/api/v1/posts/delete/${id}`);
      navigate("/AllPost");
    } catch (error) {
